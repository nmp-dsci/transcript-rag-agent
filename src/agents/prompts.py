...
PROMPT_REGISTRY: list[dict[str, object]] = [
    ...
    {"name": "SYSTEM_PROMPT", "system": "chat", "role": "system",
     "template_vars": [], "text": SYSTEM_PROMPT},
    {"name": "SUMMARY_USER_PROMPT", "system": "chat", "role": "user_template",
     "template_vars": [], "text": SUMMARY_USER_PROMPT},
    {"name": "QUESTION_USER_PROMPT", "system": "chat", "role": "user_template",
     "template_vars": ["question", "video_id"], "text": QUESTION_USER_PROMPT},
    {"name": "TRANSCRIPT_CONTEXT_PROMPT", "system": "chat", "role": "context_template",
     "template_vars": ["transcript"], "text": TRANSCRIPT_CONTEXT_PROMPT},
    # Vector RAG — single-hop
    {"name": "RAG_SYSTEM_PROMPT", "system": "vector_rag", "role": "system",
     "template_vars": [], "text": RAG_SYSTEM_PROMPT},
    {"name": "RAG_QUESTION_USER_PROMPT", "system": "vector_rag", "role": "user_template",
     "template_vars": ["question"], "text": RAG_QUESTION_USER_PROMPT},
    {"name": "HISTORY_PROMPT", "system": "vector_rag", "role": "context_template",
     "template_vars": ["turns"], "text": HISTORY_PROMPT},
    {"name": "REWRITE_PROMPT", "system": "vector_rag", "role": "user_template",
     "template_vars": ["turns", "question"], "text": REWRITE_PROMPT},
    # Recursive RAG
    {"name": "RECURSIVE_SYNTHESIS_SYSTEM_PROMPT", "system": "recursive_rag",
     "role": "system", "template_vars": [], "text": RECURSIVE_SYNTHESIS_SYSTEM_PROMPT},
    {"name": "RECURSIVE_SYNTHESIS_USER_PROMPT", "system": "recursive_rag",
     "role": "user_template",
     "template_vars": ["question", "first_answer", "first_references_block",
                       "subtopic_evidence_block"],
     "text": RECURSIVE_SYNTHESIS_USER_PROMPT},
    # Agentic RAG
    {"name": "AGENTIC_RAG_SYSTEM_PROMPT", "system": "agentic_rag", "role": "system",
     "template_vars": [], "text": AGENTIC_RAG_SYSTEM_PROMPT},
    # GraphRAG (P4)
    {"name": "GRAPH_EXTRACTION_SYSTEM_PROMPT", "system": "graph_rag", "role": "system",
     "template_vars": [], "text": GRAPH_EXTRACTION_SYSTEM_PROMPT},
    {"name": "GRAPH_EXTRACTION_USER_PROMPT", "system": "graph_rag", "role": "user_template",
    ...
    {"name": "GRAPH_ANSWER_SYSTEM_PROMPT", "system": "graph_rag", "role": "system",
     "template_vars": [], "text": GRAPH_ANSWER_SYSTEM_PROMPT},
    {"name": "GRAPH_GLOBAL_SYSTEM_PROMPT", "system": "graph_rag", "role": "system",
     "template_vars": [], "text": GRAPH_GLOBAL_SYSTEM_PROMPT},
    {"name": "GRAPH_TEMPORAL_SYSTEM_PROMPT", "system": "graph_rag", "role": "system",
     "template_vars": [], "text": GRAPH_TEMPORAL_SYSTEM_PROMPT},
]
